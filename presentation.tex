...
\DeclareFontShape{T2A}{cmss}{b}{n}{<->ssub*cmss/bx/n}{}
...
\begin{frame}{Актуальность}
  \footnotesize{
    ...
    \begin{itemize}
      \item Численно рассчитана диффузия и спектры на жидкой ветви бинодали веществ
    ...
    \begin{columns}
      \begin{column}{0.5\linewidth}
        ...
        \begin{equation}
          ...
          \label{eqGenLJ}
        \end{equation}
        \jj где $\epsilon = 1$ и $\sigma = 1$ -- энергетический и \\ пространственный масштабы соответственно.
...
\begin{frame}[shrink=20]{Вычисление диффузии и спектров в жидкости}
  \scriptsize{
    \begin{columns}
      \begin{column}{0.5\linewidth}
        \begin{center}
    ...
    \begin{equation}
      \begin{aligned}
        C(q, \omega) & \propto \frac{\Gamma_{L}}{\left(\omega-\omega_{L}\right)^{2}+\Gamma_{L}^{2}}
        +\frac{\Gamma_{L}}{\left(\omega+\omega_{L}\right)^{2}+\Gamma_{L}^{2}}                          \\
                     & \quad+\frac{(D-1)\Gamma_{T}}{\left(\omega-\omega_{T}\right)^{2}+\Gamma_{T}^{2}}
        +\frac{(D-1)\Gamma_{T}}{\left(\omega+\omega_{T}\right)^{2}+\Gamma_{T}^{2}}
      \end{aligned}
      \label{eq5}
    \end{equation}
  }
...
\begin{frame}{Результаты совместного анализа}
  \scriptsize{
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{MACR-Figure4}
...
\begin{frame}{Скорость нуклеации в переохлажденных системах}
  \footnotesize{
    ...
    \begin{figure}[!t]
      \centering
      \includegraphics[height=0.33\textheight]{otchet.pdf}
      \label{pres:otchet}
    \end{figure}
    ...
    \begin{figure}[!t]
      \centering
      \includegraphics[height=0.30\textheight]{nucleation.pdf}
      \label{nucleation}
    \end{figure}
  }
...
\begin{frame}{Результаты совместного анализа}
  \footnotesize{
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.95\textwidth]{MACR-Figure5}
      \caption{\footnotesize \textbf{Аналогичные графики для потенциала LJ12-4}}
      \label{pres:MACR-Figure5}
    \end{figure}
...
\begin{frame}{Результаты совместного анализа}
  \footnotesize{
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.95\textwidth]{MACR-Figure6}
      \caption{\footnotesize \textbf{Аналогичные графики для потенциала LJ12-5}}
      \label{pres:MACR-Figure6}
    \end{figure}
...
\begin{frame}{Результаты совместного анализа}
  \footnotesize{
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.95\textwidth]{MACR-Figure7}
      \caption{\footnotesize \textbf{Аналогичные графики для потенциала LJ16-6}}
      \label{pres:MACR-Figure7}
    \end{figure}
  }
...
\begin{frame}{Зависимость положения тройных и критических точек}
  \footnotesize{
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.95\textwidth]{NMP-Figure4}
      \caption{\footnotesize \textbf{Зависимость тройных и критических точек от дальнодействия притяжения в системе}}
      \label{pres:NMP-Figure4}
    \end{figure}
  }

  \tiny{Tsiok, E. N., Dmitryuk, N.A, \ldots Yurchenko, S. O. (2022). The role of attraction in the phase diagrams and melting scenarios of generalized 2D Lennard-Jones systems. // \textit{The Journal of Chemical Physics}}
\end{frame}
